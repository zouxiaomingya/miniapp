<template name="yq-avatar">
  <view>
    ...
    />
    <view class="oper-wrapper u-safe-btm" :style="{ display: sD, top: tp }">
      <view class="oper">
        <view class="btn-wrapper" v-if="sO">
          <!-- <view @click="fSelect" hover-class="hover" :style="{ width: bW }">
            <text>重选</text>
          </view> -->
          <view @click="fClose" :style="{ width: bW }">
            <text>取消</text>
          </view>
          <!-- <view
            @click="fRotate"
          ...
          <view @click="fUpload" :style="{ width: bW }">
            <text>完成</text>
          </view>
        </view>
...
.oper-wrapper {
  ...
  border-top: 1rpx solid #ffffff54;
  background: #000000;
  width: 100%;
  left: 0;
  bottom: 0;
